...
#                     print(soup)
    ...
    logging.info('Finished scrape_jobs function, returning df_jobs dataframe.')
...
if __name__ == "__main__":
    ...
    if not os.path.isfile(geoId_csv_processed):
        ...
        print("File '{}' created".format(geoId_csv_processed))  # for debugging while program is running.
    else:
        logging.info('Processed geoId csv file already exists')
		print("File '{}' already exists".format(geoId_csv_processed))  # for debugging while program is running.
	...
	print('Finished saving jobs as csv file')  # for debugging while program is running.
